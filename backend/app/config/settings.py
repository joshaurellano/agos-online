...
# ---------------------------------------------------------------------------
# RESTART-PROOF FALLBACK CACHE (Supabase)
# ---------------------------------------------------------------------------
#
...
# it can't help here. Instead, the last successful (PAGASA-calibrated)
# Open-Meteo response is written to Supabase (see app.weather.persistence /
# app.weather.supabase_store) by the scheduled refresh endpoint, and read
# back by every request -- see app.weather.client.fetch_weather().
#
...
# as a fallback, and shared across every app instance instead of living
